...
struct simplex
{
    ...
    void compute_table(int min_or_max = 1)
    {
        ...
        while (true)
        {
            ...
            cout << "Entering Variable at " << itrcount << " iteration is " << ss << "\n";
            ...
            cout << "Leaving Variable at " << itrcount << " iteration is " << ss << "\n\n";
...
void lab_3()
{
    ...
    cout << "Initial Simplex table is (solves prob 1,2,3 together and prints everything):\n ";
    cout << si;
